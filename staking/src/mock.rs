...
use frame_support::{
	...
	traits::{Currency, FindAuthor, Get, OnFinalize, OnInitialize, OneSessionHandler, Imbalance},
...
pub(crate) fn current_total_payout_for_duration(duration: u64) -> Balance {
	let val_burned_percentage: Perbill = <Test as Config>::ValRewardCurve::get().current_reward_coefficient(Duration::new(duration, 0));
	val_burned_percentage * 1000
}
