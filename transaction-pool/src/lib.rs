...
use sp_runtime::traits::{AtLeast32Bit, Block as BlockT, Extrinsic, NumberFor, Zero};
    ...
    PoolApi: 'static + ChainApi<Block = Block>,
{
    ...
    fn submit_at(
        ...
        self.metrics
            .report(|metrics| metrics.pending_transactions.add(xts.len() as i64));
    ...
    fn remove_invalid(&self, hashes: &[TxHash<Self>]) -> Vec<Arc<Self::InPoolTransaction>> {
        ...
        self.metrics
            .report(|metrics| metrics.pending_transactions.sub(removed.len() as i64));
        removed
    }
